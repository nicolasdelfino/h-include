...
// Cache-bust
window.HInclude.HIncludeCacheBust = (function() {
  var addCacheBust = function(element) {
    element.setAttribute('src', element.getAttribute('src') + '?' + new Date().getTime())
  };
  ...
  var HIncludeCacheBust = function() {
    return Reflect.construct(HTMLElement, arguments, HIncludeCacheBust);
  };
  HIncludeCacheBust.prototype = proto;

  customElements.define('h-include-cache-bust', HIncludeCacheBust);
  return HIncludeCacheBust;
})();
